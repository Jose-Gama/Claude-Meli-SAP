...
El archivo JSON o HTML debe ser nombrado con el título del requerimiento, error, dump o problema de rendimiento que se está abordando, para facilitar su identificación y seguimiento en el proyecto MCB. Pregunta por la ruta en la que se debe guardar el archivo JSON o HTML resultante, asegurándote de que esté correctamente ubicado dentro de la estructura del proyecto MCB para su fácil acceso y referencia futura.