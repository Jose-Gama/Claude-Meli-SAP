...
## 16. Evidencias del uso de IA generativa

Agregar las evidencias del uso de agentes de IA para la implementación ABAP de la solución que se está docuemntando. Para ello, se debe tener un input en formato JSON o HTML, en el que se indiquen los objetos modificados y/o creados por el agente, junto con una breve descripción de las líneas de código ABAP agregadas y/o modificadas
